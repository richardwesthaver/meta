#+TITLE: rambles
#+SETUPFILE: ox.setup
* Org-mode Workflows                                           :org:noexport:
:PROPERTIES:
...
can embed their usage in our writing by showing both the input and
output as text.

For example, here's how to print a weather forecast:
#+begin_src shell :results pp :exports both
shc s -w
#+end_src
#+RESULTS:
#+begin_example
00:00:00-01:00:00 = 38°F :: "Patchy Frost"
01:00:00-02:00:00 = 35°F :: "Mostly Cloudy"
02:00:00-03:00:00 = 35°F :: "Mostly Cloudy"
03:00:00-04:00:00 = 35°F :: "Cloudy"
04:00:00-05:00:00 = 35°F :: "Cloudy"
05:00:00-06:00:00 = 35°F :: "Cloudy"
06:00:00-07:00:00 = 36°F :: "Cloudy"
07:00:00-08:00:00 = 38°F :: "Chance Rain Showers"
08:00:00-09:00:00 = 42°F :: "Chance Rain Showers"
09:00:00-10:00:00 = 46°F :: "Chance Rain Showers"
#+end_example
...
[[https://orgmode.org/worg/org-contrib/babel/][org-mode babel]]. The problem is that they can only help us with
/text-based/ interfaces, and they need additional /con/-text to convey
the why. All that extra reading can make large projects more
intimidating than they need to be to newcomers.
