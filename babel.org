...
#+begin_src emacs-lisp :exports code :results html
  (format "<input id='search' name='text' type='text' placeholder='?:' />

  <script type='module'>
      const Search = new MiniSearch({
        fields: ['name','tags','content','id','path']
        searchOptions: {
          boost: { name: 3, tags: 2, content: 1 },
          fuzzy: 0.2
        }
      });
      Search.addAll(fetch('https://cdn.otom8.dev/data/org-graph-index.json'));
    </script>")
#+end_src

#+RESULTS: org-graph-search
#+begin_export html
<input id='search' name='text' type='text' placeholder='?:' />
