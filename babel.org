...
<script type='module'>
    ...
    const Graph = new ForceGraph3D(document.getElementById('3d-graph'),{controlType: 'orbit'})
      ...
      .nodeThreeObject(node => {
        ...
        sprite.color = node.color;
        sprite.textHeight = 8;
        sprite.center.y = 0.6; // shift below node
        return sprite;
      })
      .nodeThreeObjectExtend(true);
</script>
     ...
     (mapcar 
      (lambda (s)
        (mapcar 
         ...
         (doc:doc-files s)))
      (doc:doc-dependencies (doc:asdf-system-documentation system)))))
#+end_src
* lisp-system-files                                                    :lisp:
:PROPERTIES:
...
#+begin_src lisp :var system='user :results replace
  (let ((system (find-system system)))
    (flatten
     (mapcar 
      (lambda (x) (remove-string (namestring (system-home system)) (namestring x)))
      (doc:doc-files (doc:asdf-system-documentation system)))))
...
#+begin_src lisp :var system='user :results replace
  (mapcar 'name (doc:doc-dependencies (doc:asdf-system-documentation system)))
#+end_src
...
#+begin_src lisp :var system='user :results replace
  (mapcar 'name (doc:doc-packages (doc:asdf-system-documentation system)))
#+end_src
...
:PROPERTIES:
:ID:       97639bea-6df8-4bd3-8e22-24b6db6057e9
:END:
