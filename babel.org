...
| file          | size | modified            |
|---------------+------+---------------------|
| [[https://github.com/richardwesthaver/meta/blob/default/babel.org][babel.org]]     | 35k  | 2025-02-15 16:14:29 |
...
| [[https://github.com/richardwesthaver/meta/blob/default/readme.org][readme.org]]    | 1.2k | 2025-02-10 20:43:11 |
| [[https://github.com/richardwesthaver/meta/blob/default/style.org][style.org]]     | 3.2k | 2024-09-29 23:03:07 |
| [[https://github.com/richardwesthaver/meta/blob/default/tech.org][tech.org]]      | 3.6k | 2024-09-29 23:01:07 |
                  ...
                  (when-let ((attr (file-attributes x)))
                    (let ((y (if (string= (file-name-base x) "readme")
                                 (let ((s (file-name-split x)))
                                   (apply 'file-name-concat (butlast s) (list "index.html")))
                               (file-name-with-extension x "html"))))
                      (list (format "[[%s][%s]]"
                                    (format link-fmt name y) (file-name-sans-extension y))
                            (format-time-string "%Y-%m-%d %H:%M:%S" (file-attribute-modification-time attr))))))
                (cl-remove-if (lambda (x)
                                (or
                                 (cl-member-if
...
| file      | modified            |
|-----------+---------------------|
| [[https://compiler.company/meta/babel.html][babel]]     | 2025-02-23 21:00:34 |
