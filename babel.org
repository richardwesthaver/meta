...
| root        | ~/comp/org/meta/                                          |
| vc          | :hg [[https://vc.compiler.company/meta][vc.compiler.company/meta]] :rev [[https://vc.compiler.company/meta/rev/7ad8b787d298][7ad8b787d298:65+]]        |
...
| file          | size | modified            |
|---------------+------+---------------------|
| [[https://github.com/richardwesthaver/meta/blob/default/babel.org][babel.org]]     | 223k | 2025-03-15 15:41:17 |
...
| [[https://github.com/richardwesthaver/meta/blob/default/readme.org][readme.org]]    | 3.2k | 2025-03-09 14:41:10 |
...
| file      | modified            |
|-----------+---------------------|
| [[file:babel.org][babel]]     | 2025-05-13 17:31:11 |
| [[file:readme.org][readme]]    | 2025-05-11 01:09:25 |
...
#+begin_src emacs-lisp :results silent :eval no-export
  (when (slime-connected-p)
    (slime-eval '(asdf:load-system :core/user))
    (slime-repl-set-package "USER"))
#+end_src
* TODO prelude-slime                                                   :lisp:
:PROPERTIES:
:ID:       9ffd1d10-ffad-486e-9d7d-82422342b9ff
:CREATED:  <2025-06-04 Wed 20:38>
:END:
:LOGBOOK:
- State "TODO"       from              [2025-06-04 Wed 20:38]
:END:
#+name: load-prelude
#+begin_src emacs-lisp :results silent :eval no-export
  (when (slime-connected-p)
