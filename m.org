...
#+header: :var lc=(org-sbx wc-dir-lines (dir (concat "/home/ellis/shed/src/" (org-sbx org-current-heading-title)))) wc=(org-sbx wc-dir-words (dir (concat "/home/ellis/shed/src/" (org-sbx org-current-heading-title))))
...
#+begin_src emacs-lisp :exports results :eval no-export
        (let* ((nf (format "[[https://rwest.io/m#%s][%s]]" name name))
               ...
               (vf (format "%s, %s" rf gf))
               (cf (format "%s lines, %s words" lc wc)))
          `(("name" ,nf)
            ("version" ,ver)
            ("vc" ,vf)
            ("updated" ,age)
...
| m.org      | 38K  | 2021-11-17-23:51 |
| n.org      | 229K | 2021-11-14-17:37 |
| ox.setup   | 580  | 2021-11-14-23:06 |
| readme.org | 8.7K | 2021-11-17-23:25 |
...
**** hg-export-github                                           :noexport:
:PROPERTIES:
:CUSTOM_ID: meta-prod-hg-export-github
:END:
...
| version | alpha-0.1               |
| vc      | [[https://hg.rwest.io/babel/rev/7f8740fdf0a4][74:7f8740fdf0a4]], [[https://github.com/richardwesthaver/babel][github]] |
| updated | 23 hours ago            |
| count   | 1031 lines, 3791 words  |
