...
:END:
this script requires =STAMP= and =SHED= env vars.
#+begin_src bash :results output
  REPOS=("meta" "shed" "babel" "cfg" "tenex")
  WD=$STAMP
  for r in ${REPOS[@]}; do
      src=$SHED/src/$r
...
#+RESULTS:
#+begin_example
~/shed/stash/tmp/meta ~/shed/src/meta
ok
[default 6c90355] from https://hg.rwest.io/meta
 Committer: ellis <ellis@lab.zor>
